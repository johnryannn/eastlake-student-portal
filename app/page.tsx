      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5">
          <div className="flex items-center gap-4">
            <div className="grid h-12 w-12 place-items-center rounded-xl border-2 border-blue-800 bg-white text-lg font-black tracking-tight text-blue-900 shadow-sm ring-2 ring-blue-100">
              ESM
            </div>
            <div>
